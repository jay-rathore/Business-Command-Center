...
export const NAV_MODULES: NavModule[] = [
  ...
  { key: 'sales-team', label: 'Sales Team', route: '/sales-team', phase: 1 },
  { key: 'dealers', label: 'Dealers', route: '/dealers', phase: 1 },
  { key: 'architects', label: 'Architects', route: '/architects', phase: 1 },
  { key: 'builders', label: 'Builders', route: '/builders', phase: 1 },
